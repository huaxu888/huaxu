				...
				<view class="title_ padding bg-white" style="position: relative;bottom:00upx;">
					...
					<view class="flex align-start" style="margin-bottom: 26upx;">
						<view class="shop_img margin-right" style="position: relative;">
							<image :lazy-load="lazyLoad" class="logo_img" :src="infoObject.LogoPic===''?'https://img.huaxuapp.com/huaxulogo70px.png':infoObject.LogoPic"
							...
							<!-- <image src="https://img.huaxuapp.com/200-200.png" mode="aspectFit" v-if="infoObject.IsSY"
								...
								<image src="https://img.huaxuapp.com/zd200-200.png" mode="aspectFit" v-if="infoObject.IsSY"
									style="position: absolute;width: 200rpx;height: 200rpx;top: 0;left: 0;"></image>
						</view>
						<view style="line-height:40upx;">
							...
							<view class="star_">
								<text class="hxIcon-tubiaozhizuomoban start-red" style="font-size: 24upx;margin-right: 4upx;" v-for="(item,i) in infoObject.StoreStart"
								 :key="i"></text>
								 <text class="hxIcon-tubiaozhizuomoban " style="font-size: 24upx;color: #bbbbbb;margin-right: 4upx;" v-for="(it,i) in xXing" :key="i"></text>
