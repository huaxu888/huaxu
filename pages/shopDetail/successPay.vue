<template>
	<view style="background: #ffffff;">
		<cu-custom bgColor="bg-whitesss" :isBack="true">
			<!-- #ifdef APP-PLUS || H5-->
			<block slot="content"><text>花蓄精选</text></block>
			<!-- #endif -->
			<!-- #ifdef MP-WEIXIN -->
			<block slot="content"><text>花蓄精选</text></block>
			<!-- #endif -->
		...
		<view class="" style="background-color: #FFFFFF;text-align: center;margin-top: 80upx;">
			<view class="cuIcon-roundcheckfill" style="font-size: 120upx;color: #2bba12;"></view>
			<view style="font-size: 40upx;font-weight: 600;margin-top: 15upx;color: #000000;">支付成功</view>
		</view>
