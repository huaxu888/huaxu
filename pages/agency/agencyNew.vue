<template>
	<view>
		...
		<view>
			<view class="flex" style="font-weight: 600;margin-left: 30upx;margin-top: 50upx;">
				<text style="color: #f8a227;font-size: 36upx;">|</text><text style="margin-left: 12upx;font-size: 36upx;">申请流程</text>
			</view>
			<image src="https://img.huaxuapp.com/dllct_02.jpg" mode="" style="width: 750upx;height: 138upx;margin-top: 40upx;"></image>
			<view class="flex" style="font-weight: 600;margin-left: 30upx;margin-top: 80upx;">
				<text style="color: #f8a227;font-size: 36upx;">|</text><text style="margin-left: 12upx;font-size: 36upx;">联系信息</text>
			</view>
		</view>
		
		<view class="padding-lr" style="position: relative;width: 100%;height: 850upx;margin-top: 70upx;">
			<view class="padding-lr">
				<view class="padding-lr margin-top">
					<view class="margin-top">
						<hx-input paddingSize="sm" placeholder="请输入您的姓名" v-model="Uname"></hx-input>
					</view>
					<view class="margin-top" style="margin-top: 60upx;">
						<hx-input paddingSize="sm" placeholder="请输入手机号码" v-model="Phone" :model="Phone" :disable="disable"></hx-input>
					</view>
					<view class="margin-top" style="margin-top: 40upx;">
				...
				<view class="flex align-center justify-center hx-btn radius margin-top-xl sure" @tap="submit" data-target="DialogModal2">
