	...
	<view>
		<view v-if="!showFlag" style="background-image: url(https://img.huaxuapp.com/qudlbg_02.png);background-repeat: no-repeat;background-size: cover;width: 750upx;height: 510upx;">
			...
			<cu-custom bgColor="" class="text-white" :isBack="true">
				<!-- #ifdef APP-PLUS || H5-->
				<block slot="content">花蓄区域代理</block>
				<!-- #endif -->
				<!-- #ifdef MP-WEIXIN -->
				<block slot="content">花蓄区域代理</block>
				<!-- #endif -->
			...
			<view>
				<view class="padding-lr padding-top" style="">
					...
					<view class="flex justify-center" style="margin-top: 60upx;">
						<view style="background-color: #ffffff;width: 676upx;height: 210upx;margin-top: 0upx;border-radius: 20upx;-moz-box-shadow:0px 0px 4px 0px #dddddd;-webkit-box-shadow:0px 0px 4px 0px #dddddd;box-shadow:0px 0px 4px 0px #dddddd;">
							<view style="position: relative;">
								...
								<view style="font-weight: 600;font-size: 42upx;color: #000000;text-align: center;margin-top: 30upx;">
									<text>{{changeMoney(totalsum) || 0}}元</text>
								</view>
							</view>
				...
				<view class="flex justify-center" style="margin-top: 40upx;">
					<view style="background-color: #ffffff;width: 678upx;height: 415upx;margin-top: 0upx;border-radius: 20upx;-moz-box-shadow:0px 0px 4px 0px #dddddd;-webkit-box-shadow:0px 0px 4px 0px #dddddd;box-shadow:0px 0px 4px 0px #dddddd;">
						<view @tap="myShop" style="background-color: #ffffff;height: 103upx;line-height: 103upx;display: flex;justify-content: space-between;padding: 0 30upx;border-radius: 20upx 20upx 0 0;">
							...
							<view class="flex align-center">
								<view style="color: #b9b9b9;font-size: 24upx;">{{ShopCount || 0}}个</view>
...
<script>
	export default {
		...
		onShow() {
			...
			this.$http.areaDetail(this.$store.state.userInfo.ID).then(res => {
		...
		methods: {
			...
			gotoSh(){
				uni.navigateTo({
					url:'/pages/personalAgent/araemingxiAgent?agentType=' + this.agentType
				})
			},
			gotoZh(){
				uni.navigateTo({
			...
			poutMoney(){
				...
				// })
				uni.navigateTo({
					url:'/pages/personalAgent/tixianAgent'
				})
			},
			moneyIsTrue(num){
				if(num>=100){
