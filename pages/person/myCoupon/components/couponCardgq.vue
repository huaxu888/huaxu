<template>
	<view style="color: #cccccc;">
		<view style="background-image: url(https://img.huaxuapp.com/gqq690186.png);
		background-repeat: no-repeat;width: 690upx;height: 186upx;background-size: cover;padding: 30upx 30upx;padding-top: 20upx; position: relative;" v-if="type === 'noShop'&& itemObj.Title !== '留坝通用券'&&itemObj.StoreId !== 1129">
			<view class="flex" style="">
				
				<view style="text-align: center;width: 110upx;margin-top: 10upx;">
				...
				<view style="margin-left: 70upx;width: 320upx;">
					...
					<view style="color: #cccccc;margin-top: 10upx; ">
						<text style="border: 1upx solid #cccccc;padding: 0 10upx;font-size: 20upx;border-radius: 5upx;height: 34upx; " v-if="itemObj.CouponSort == 1 ||  itemObj.CouponSort == 2 && type === 'noShop'">
						...
						<text style="border: 1upx solid #cccccc;padding: 0 10upx;font-size: 20upx;border-radius: 5upx;height: 34upx; "
				...
				<view style="width: 140upx; height: 52upx;line-height: 52upx;border-radius: 40upx;margin-top: 18upx;text-align: center;">
					<text class="hxIcon-yiguoqi" style="font-size: 140upx;color: #b1b1b1;">
						
					</text>
				</view>
			</view>
			<view style="margin-top: 12px;justify-content:space-between;position: relative;" class="flex">
		...
		<view  style="font-size:24upx;color: #666666;background-color: #fffaf9;height: 84upx;line-height: 84upx;padding-left: 40upx;border-radius: 0 0 15upx 15upx;" v-if="ShowHidden">
		...
		<view class="flex flex-direction align-center justify-between" style="border-radius: 10upx 10upx 20upx 20upx;width: 696upx; overflow: hidden;" v-if="itemObj.CouponSort == 2 && itemObj.MianE == 30 && type === 'noShop' && itemObj.SiteID == 9">
		    <image src="https://img.huaxuapp.com/0707ty_03.png" style="width: 699rpx ;height: 255rpx;"  mode="widthFix"></image>
			<view class="flex align-center justify-between padding-tb-sm padding-lr-xs bg-white" style="width: 100%;" >
				<view class="text-sm text-gray">使用期限：{{BDate}} - {{EDate}}</view>
				<view style="width: 140upx; height: 52upx;line-height: 52upx;border-radius: 40upx;text-align: center;margin-right: 20upx;z-index: 2;">
					<text class="hxIcon-yiguoqi" style="font-size: 140upx;color: #b1b1b1;">
		...
		<view class="flex flex-direction align-center justify-between" style="border-radius: 10upx 10upx 20upx 20upx;width: 696upx; overflow: hidden;"    v-if="itemObj.CouponSort == 1 && itemObj.StoreId == 1129 && itemObj.MianE == 1 &&type === 'noShop' ">
		...
		<view class="flex flex-direction align-center justify-between" style="border-radius: 10upx 10upx 20upx 20upx;width: 696upx; overflow: hidden;"  v-if="itemObj.CouponSort == 1 && itemObj.StoreId == 1129 && itemObj.MianE == 500 &&type === 'noShop' ">
