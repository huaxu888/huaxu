<template>
	<view>
		<view style="background-image: url(https://img.huaxuapp.com/yhqbg.png);
		background-repeat: no-repeat;width: 690upx;height: 184upx;background-size: cover;padding: 30upx 30upx;padding-top: 20upx; position: relative;" v-if="type === 'noShop'&& itemObj.Title !== '留坝通用券'&&itemObj.StoreId !== 1129">
			<view class="flex" style="">
				...
				<view style="width: 140upx; height: 52upx;line-height: 52upx;border-radius: 40upx;margin-top: 18upx;text-align: center;">
					<text class="hxIcon-yishiyong" style="font-size: 140upx;color: #b1b1b1;">
