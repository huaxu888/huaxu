<template>
	<view>
		...
		<view class="padding-bottom-sm  bg-jingying" style="padding-top:50upx;padding-bottom: 0upx;height: 332upx;">
			<view class="flex justify-center align-center">
				<text class="cuIcon-roundcheck" style="font-size: 108upx;color: #fe5479;"></text>
			</view>
			<view class="flex justify-center align-center" style="margin-top: 30upx;">
				<text style="font-size: 36upx;font-weight: 600;color: #fe5479;">提现审核中！</text>
			</view>
			<view class="" style="margin-top: 16upx;width: 100%;text-align: center;color: #fa8da5;">
				<text style="font-size: 24upx;">{{chuLi(Custom.BankName)}}</text>
				<text style="font-size: 24upx;"><text>{{Custom.BankNO}}</text></text>
			</view>
		</view>
