...
<style lang="scss" scoped>
	.rob-stamps-page {
		...
		.bg {
			width: 750upx;
			height: 1800upx;
			background: url(https://img.huaxuapp.com/100jian300806.png) no-repeat;
		...
		.qiang {
			width: 218upx;
			height: 218upx;
			background: url(https://img.huaxuapp.com/qanlb_03.png) no-repeat;
			background-position: center;
			background-size: cover;
		}
