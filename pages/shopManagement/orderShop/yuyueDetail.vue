<template>
	<view class="order-managment-page">
		<cu-custom bgColor="bg-whitesss" :isBack="true">
			<!-- #ifdef APP-PLUS || H5-->
			<block slot="content"><text>预约订单详情</text></block>
			<!-- #endif -->
			<!-- #ifdef MP-WEIXIN -->
			<block slot="content"><text>预约订单详情</text></block>
			<!-- #endif -->
		...
		<view class="reservation-list-page">
			<view class="reservation-list-item">
				<view class="reservation-cotent">
					<view class="flex justify-between align-center" style="margin: 30upx;margin-bottom: 0;margin-top: 0;border-bottom: 1.5upx solid #e4e4e4;padding:30upx 0;" @tap="gotoShop">
						...
						<view class="flex align-center" style="color: #999999;" @tap="callShop(13744549168)">
							<view class="hxIcon-dianhua2" style="font-size: 42upx;margin-right: 14upx;"></view>
							<view style="font-size: 28upx;color: #333333;">13744549168</view>
						</view>
					</view>
				</view>
			</view>
