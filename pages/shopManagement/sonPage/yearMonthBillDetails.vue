		...
		<view>
			<view class="flex  align-center justify-between  "  style="background: #ffffff;padding: 30upx 30upx; border-top: 1upx solid #dfdfdf;" :class="billType==='daili'?'padding-lr':''">
				<view style="width: 280upx;">
					<u-subsection :list="list" :current="curNow" @change="sectionChange" bg-color="#ffffff" button-color="#e8b87f" 
					active-color="#ffffff"  inactive-color="#e8b87f" style="color: #e8b87f;"></u-subsection>
				</view>
