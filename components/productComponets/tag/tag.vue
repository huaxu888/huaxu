<template>
	<view class="tui-tag-class" :class="[size?'tui-tag-'+size:'tui-tag',getClassName(shape,plain),getTypeClass(type,plain)]"  :style="{margin:margin+'upx'}"
...
.tui-high-yellow-outline {
  color: #f8cd18 !important;
  background: none;
}

.tui-high-yellow-outline::after {
  border: 1px solid #f8cd18 !important;
}

.tui-choose-yellow-outline {
  color: #FFAB05 !important;
  background: #FFFBF3 !important;
}

.tui-choose-yellow-outline::after {
  border: 1px solid #C9C59D !important;
}
