...
<template>
	<view>
		<view style="display: flex; height: 100upx; justify-content: center; align-items: center;border-bottom: 1px solid #CCCCCC;">
			<text class="hxIcon-cha" style="position: absolute; left: 20upx; font-size: 40upx;" @tap="close"></text>
		...
		<navigator url="/pages/person/setting/payPass" hover-class="none">
			<view style="margin-top:20upx;color: #007AFF;"><text style="color:  #AAAAAA;">(初始密码888888)</text>去修改支付密码</view>
		</navigator>
