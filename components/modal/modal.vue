<template>
	<view @touchmove.stop.prevent>
		<view class="tui-modal-class tui-modal-box " :class="[show?'tui-modal-show':'',isPadding?'tui-padding':'']">
			<view v-if="!custom">
